    ...
    <div className="mt-8 rounded-lg border border-dashed border-muted-foreground/20 p-4">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 rounded border border-muted-foreground/20 bg-transparent px-3 py-1.5 text-[13px] text-foreground outline-none placeholder:text-muted-foreground/30 focus:border-primary/40"
        />
        <button
          type="submit"
